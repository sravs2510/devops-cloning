...
module "create_eu_ssm" {
  ...
  opensearch_host                       = var.STAGE == "prod" ? try(module.create_eu_opensearch[0].opensearch_host, "") : join("", [module.create_opensearch_eu_ec2[0].private_ip, ":9200"])
...
module "create_in_ssm" {
  ...
  datacenter_codes                      = var.datacenter_codes
  open_ai_api                           = var.open_ai_api
  opensearch_host                       = var.STAGE == "prod" ? try(module.create_in_opensearch[0].opensearch_host, "") : join("", [module.create_opensearch_in_ec2[0].private_ip, ":9200"])
...
module "create_sea_ssm" {
  ...
  datacenter_codes                      = var.datacenter_codes
  open_ai_api                           = var.open_ai_api
  opensearch_host                       = var.STAGE == "prod" ? try(module.create_sea_opensearch[0].opensearch_host, "") : join("", [module.create_opensearch_sea_ec2[0].private_ip, ":9200"])
...
module "create_us_ssm" {
  ...
  datacenter_codes                      = var.datacenter_codes
  open_ai_api                           = var.open_ai_api
  opensearch_host                       = var.STAGE == "prod" ? try(module.create_us_opensearch[0].opensearch_host, "") : join("", [module.create_opensearch_us_ec2[0].private_ip, ":9200"])
