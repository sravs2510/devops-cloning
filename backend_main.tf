...
module "create_in_ssm" {
  ...
  ssm_config = {
    parameters = {
      ...
      "qatalyst-config-ddb-stream-arn"        = module.create_global_dynamodb.ddb_stream_arns["qatalyst-configurations"]"qatalyst-config-ddb-stream-arn" = module.create_global_dynamodb.ddb_stream_arns["qatalyst-configurations"]["ap-south-1"],
