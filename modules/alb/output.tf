...
output "qatalyst_alb_target_group_prototype_arn" {
  value = aws_lb_target_group.qatalyst_prototype_tg.arn
}

output "qatalyst_alb_target_group_prototype_arn_suffix" {
  value = aws_lb_target_group.qatalyst_prototype_tg.arn_suffix
}