...
#Batch
output "qatalyst_batch_service_role_arn" {
  value = aws_iam_role.qatalyst_batch_service_role.arn
}

output "qatalyst_ecs_task_execution_role_arn" {
  value = aws_iam_role.qatalyst_helios_ecs_task_execution_role.arn
}

output "qatalyst_ecs_task_role_arn" {
  value = aws_iam_role.qatalyst_helios_ecs_task_role.arn
}