...
#EFS
module "create_eu_celery_efs" {
  source            = "./modules/efs"
  STAGE             = var.STAGE
  DEFAULT_TAGS      = var.DEFAULT_TAGS
  EFS_CONFIGURATION = var.celery_efs_configurations
...
#ECS
module "create_eu_ecs_celery_service" {
  source                        = "./modules/ecs-service"
  ecs_service_name              = local.qatalyst_celery_service_name
  ...
  ecs_task_role_arn             = module.create_iam.celery_ecs_task_role_arn
  ecs_autoscale_role_arn        = module.create_iam.qatalyst_ecs_autoscale_role_arn
  fargate_cpu_memory            = var.fargate_cpu_memory
  service_environment_variables = local.qatalyst_celery_ecs_task_environment_variables
  service_environment_secrets   = local.qatalyst_celery_ecs_task_environment_secrets
  ...
  service                       = var.service_names["celery"]
  efs_file_system_id            = module.create_eu_celery_efs.efs_id
  efs_access_point_id           = module.create_eu_celery_efs.access_point_id
  EFS_CONFIGURATION             = var.celery_efs_configurations
...
module "create_in_ecs_celery_service" {
  source                        = "./modules/ecs-service"
  ecs_service_name              = local.qatalyst_celery_service_name
  ...
  repo_name                     = var.ecr_repo_name
  service                       = var.service_names["celery"]
  efs_file_system_id            = module.create_in_celery_efs.efs_id
  efs_access_point_id           = module.create_in_celery_efs.access_point_id
  EFS_CONFIGURATION             = var.celery_efs_configurations
...
module "create_sea_ecs_celery_service" {
  source                        = "./modules/ecs-service"
  ecs_service_name              = local.qatalyst_celery_service_name
  ...
  repo_name                     = var.ecr_repo_name
  service                       = var.service_names["celery"]
  efs_file_system_id            = module.create_sea_celery_efs.efs_id
  efs_access_point_id           = module.create_sea_celery_efs.access_point_id
  EFS_CONFIGURATION             = var.celery_efs_configurations
...
module "create_us_ecs_celery_service" {
  source                        = "./modules/ecs-service"
  ecs_service_name              = local.qatalyst_celery_service_name
  ...
  repo_name                     = var.ecr_repo_name
  service                       = var.service_names["celery"]
  efs_file_system_id            = module.create_us_celery_efs.efs_id
  efs_access_point_id           = module.create_us_celery_efs.access_point_id
  EFS_CONFIGURATION             = var.celery_efs_configurations
